...
@section('content')
    ...
    <div class="roomDetail">
        ...
        <div class="roomDetailText">
            <div class="container">
                <span>Sea and nature waiting for awakening you.<br> Port Nature creates a peaceful and rejuvenating atmosphere</span>
            </div>
        </div>
        <div class="container">
                    ...
                    <div class="other-room-wrapper">
                        <div class="otherRoomImage firstRoom">
                            <a class="roomlink" href="{{ route('kingsuit-rooms') }}">
                                <figure>
                                    <img src="{{ asset('assets/frontend/images/home/kingSuite.webp') }}"
                                         alt="kingSuite"/>
                                </figure>
                                <h4>King Suite</h4>
