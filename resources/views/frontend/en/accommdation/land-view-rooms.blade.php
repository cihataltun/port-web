...
@section('title', 'Standard Land View Room - PORT Nature Luxury Resort Hotel & Spa')
...
<div class="roomDetail">
    ...
    <div class="roomDetailText">
        <div class="container">
            <span>If you say "I have to see and breathe nature"<br> Land view rooms for you.</span>
        </div>
    </div>
    <div class="container">
