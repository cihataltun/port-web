...
@section('title', 'Mini Club Ala Carte - PORT Nature Luxury Resort Hotel & Spa')
            ...
            <div class="swiper mainRestSlider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide leftImage">
                        <a class="lightbox-miniclub" href="{{ asset('assets/frontend/images/miniclubalacarte/miniAlaCarte-1.webp') }}">
                            <figure>
...
<div class="restaurantInfo">
    ...
    <div class="restaurantText">
        ...
        <p>Port Nature Mini Club A’la Carte macht alles für Ihre Kinder, wie gesundes und leckeres Essen, Sicherheitsbereich und qualifiziertes Personal.</p>
