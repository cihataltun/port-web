    ...
    start(e, n) {
        ...
        this.config = {
            ...
            acceptBtn: {
                ...
                background: n.acceptBtnBackground || "#253b48",
                color: n.acceptBtnColor || "#fff"
            },
            rejectBtn: {
                text: n.rejectBtnText || t.rejectBtnText,
                background: n.rejectBtnBackground || "#E8E8E8",
                color: n.rejectBtnColor || "#636363"
            },
            manageCookies: {
                color: n.manageColor || "#1d2e38",
                background: n.manageBackground || "#fff",
